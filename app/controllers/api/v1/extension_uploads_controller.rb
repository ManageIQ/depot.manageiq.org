...
class Api::V1::ExtensionUploadsController < Api::V1Controller
  ...
  #
  # There are two use cases for sharing a extension: adding a new extension to
  # the community site, and updating an existing extension. Both are handled by
  # this action.
  #
  # There are also several failure modes for sharing a extension. These include,
  ...
  #
  # The parameters required to upload a extension
  #
