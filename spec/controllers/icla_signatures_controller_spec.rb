...
describe IclaSignaturesController, skip: "Passes in isolation; some failures in full suite" do
  ...
  context 'routes requiring authentication' do
    ...
    describe 'GET #new' do
      ...
      context 'when the user has no linked GitHub accounts', pending: "no ccla" do
        before do
