...
#         owner: create(:user, chef_account: create(:account, provider: 'github', username: 'johndoe'), create_chef_account: false),
#         cookbook_versions: [
#           create(
#             :cookbook_version,
...
#         name: 'redisio',
#         category: create(:category, name: 'datastore'),
#         owner: create(:user, chef_account: create(:account, provider: 'github', username: 'fanny'), create_chef_account: false),
#         cookbook_versions: [
#           create(
#             :cookbook_version,
