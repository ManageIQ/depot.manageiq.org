...
describe Universe do
  ...
  it 'allows you to customize things' do
    ...
    expect(Universe.download_url(extension, version, 'https://narf.example.com:6060')).to eql('https://narf.example.com:6060/api/v1/extensions/redis/versions/1.3.1/download')
  end
  ...
  it 'does not print the port if it is not set' do
    ...
    expect(Universe.download_url(extension, version, 'http://narf.example.com')).to eql('http://narf.example.com/api/v1/extensions/redis/versions/1.3.1/download')
  end
